...
//========================================================================
{
	...
	begin();	// add to this widget
	{
		...
		waveBrowser = new Fl_Browser(605,pty,120,75,"Spline Type");
		...
		amplitude = new Fl_Value_Slider(670, pty, 120, 20, "Amplitude");
		amplitude->range(0, 1);
		amplitude->value(0.1);
		...
		pty += 25;
		 ...
		 waveLength= new Fl_Value_Slider(670, pty, 120, 20, "Wave Length");
		...
		pty+=30;
		pixel = new Fl_Button(605, pty, 40, 20, "pixel");
		togglify(pixel);
